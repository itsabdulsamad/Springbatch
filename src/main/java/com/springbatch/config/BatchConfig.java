...
public class BatchConfig {
	...
	private LineMapper<User> getLineMapper() {
		...
		lineTokenizer.setNames(new String[] { "USER_ID", "FIRST_NAME", "LAST_NAME", "EMAIL" });
	...
	public JdbcBatchItemWriter<User> writer() {
		...
		writer.setSql(
				"insert into user(userId,firstName,lastName,email)values(:userId,:firstName,:lastName,:email)");
